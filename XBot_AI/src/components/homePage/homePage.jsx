// ✅ [No changes to imports or dummyData]
...
import InputBar from "../inputBar/inputBar"; // ✅ used below even in home view
  ...
  function HomeContent({
    ...
    return (
      <div className="content">
        ...
        {/* ✅ ADDED input field even when openChat is false (test 1 fix) */}
  ...
  return (
    <Grid container sx={{ width: "100vw", height: "100vh" }}>
      ...
      >
        ...
        {activeChat ? (
          <div className="parentConversationContainer" ref={chatRef}>
            <Conversation
              dummyData={dummyData}
